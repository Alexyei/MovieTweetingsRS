...
| Параметр      | Описание                                                                                        | Мой тип | Значение у меня | Тип Фалька | Значение Фалька |
| ------------- | ----------------------------------------------------------------------------------------------- | :-----: | --------------: | :--------: | --------------: |
| *min_sims*    | Минимальное сходство элементов необходимое для их сохранения сходства в таблице                 |   *>*   |             0.05 |            |                 |
| *min_overlap* | Количество ОБЩИХ фильмов между пользователями, необходимое для их сохранения сходства в таблице |   *>*   |               10 |            |                 |

### cf_nb_user_user_recommender

| Параметр         | Описание                                                                                                                        | Мой тип | Значение у меня | Тип Фалька | Значение Фалька |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------- | :-----: | --------------: | :--------: | --------------: |
| *min_sims*       | Минимальное сходство пользователей необходимое для извлекаемых записей из таблиц сходств                                        |   *>*   |             0.1 |            |                 |
| *min_overlap*    | Минимальное количество схожих пользователей посмотревших рекомендуемый фильм                                                    |  *>=*   |               2 |            |                 |
...
| *ncandidates*    | Максимальное количество схожих пользователей извлекаемое из таблицы сходств для пользователя                                               |  *==*   |             100 |            |                 |
