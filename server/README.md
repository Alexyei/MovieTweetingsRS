...
| ------------- | ----------------------------------------------------------------------------------------------- | :-----: | --------------: | :--------: | --------------: |
| *min_sims*    | Минимальное сходство элементов необходимое для их сохранения сходства в таблице                 |   *>*   |             0.2 |    *>*     |             0.0 |
| *min_overlap* | Количество пользователей оценивших ОБА фильма, необходимое для их сохранения сходства в таблице |   *>*   |               1 |    *>*     |              20 |
