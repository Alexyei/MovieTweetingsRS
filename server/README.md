...
| ------------- | ----------------------------------------------------------------------------------------------- | :-----: | --------------: | :--------: | --------------: |
| *min_sims*    | Минимальное сходство элементов необходимое для их сохранения сходства в таблице                 |   *>*   |             0.2 |    *>*     |             0.2 |
| *min_overlap* | Количество пользователей оценивших ОБА фильма, необходимое для их сохранения сходства в таблице |   *>*   |               2 |    *>*     |              20 |

### cf_nb_item_item_recommender

| Параметр         | Описание                                                                                     | Мой тип | Значение у меня | Тип Фалька | Значение Фалька |
| ---------------- | -------------------------------------------------------------------------------------------- | :-----: | --------------: | :--------: | --------------: |
| *min_sims*       | Минимальное сходство элементов необходимое для извлекаемых записей из таблиц сходств         |   *>*   |             0.2 |    *>*     |             0.0 |
